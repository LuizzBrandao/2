...
// ============================================
// CRIAR BANCO E SEED SIMPLES (para iniciantes)
// ============================================
try
{
    using var scope = app.Services.CreateScope();
    var ctx = scope.ServiceProvider.GetRequiredService<FitLifeContexto>();
    // Garante criação do banco sem exigir migrações manuais
...
catch (Exception ex)
{
    ...
    Console.WriteLine("Erro ao garantir banco/seed: " + ex.Message);
}
