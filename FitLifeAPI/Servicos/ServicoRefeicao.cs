...
namespace FitLifeAPI.Servicos
{
    public class ServicoRefeicao : IServicoRefeicao
    {
        ...
        public async Task<RefeicaoDTO?> AtualizarAsync(int id, AtualizarRefeicaoDTO dto)
        {
            var refeicao = await _contexto.Refeicoes.FindAsync(id);
            if (refeicao == null) return null;

            // Atualiza campos permitidos
            refeicao.Nome = dto.Nome;
            refeicao.Descricao = dto.Descricao;
            refeicao.Calorias = dto.Calorias;
            refeicao.ProteinaGramas = dto.ProteinaGramas;
            refeicao.CarboidratosGramas = dto.CarboidratosGramas;
            refeicao.GordurasGramas = dto.GordurasGramas;
            refeicao.TipoRefeicao = dto.TipoRefeicao;
